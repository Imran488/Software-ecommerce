...
<section id="privacy-policy">
    ...
    <div class="blur-effect m-auto px-5">
        <u><h1 style="color:green;" class="py-3 text-center fw-bold">Cookies <span >Policy</span>
        </h1></u>
    </div>
<br>
    <div class="container py-5">
        {{-- <h1>Privacy Policy for BGD LLC</h1> --}}
        <div class="col-8 mx-auto">
            <h3 style="color:green;">Cookie Policy</h3>
            <p>We use cookies to help improve your experience of our website at https://www.bgdtech.uk. This cookie policy is part of BGD LLC's privacy policy. It covers the use of cookies between your device and our site. </p>
            ...
            <h3 style="color:green;">What is a cookie?</h3>
            ...
            <h3 style="color:green;">Types of cookies and how we use them</h3>
            ...
            <h3 style="color:green;">Functionality cookies</h3>
