                    ...
                    <div class="col-md-4 col-sm-5">
                        <div class="romana_contact_form_left">
                            <div class="romana_single_contact">
                                <h3>Support</h3>
	                            <ul>
	                                <li><a href="#"><strong><i class="fas fa-phone"></i>   Phone :</strong> +447441445018</a></li>
	                                <li><a href="#"> <strong><i class="fas fa-phone"></i>  Landline :</strong> +447441445018 </a></li>
	                                <li><a href="mailto:info@bgdonline.net"> <strong><i class="far fa-envelope"></i>  Email :</strong> info@bgdtech.uk</a></li>
                            ...
                            <div class="romana_single_contact">
                               <h3>Address</h3>
	                            <ul>
	                                <li><a href="#"><strong><i class="fas fa-map-marked-alt"></i>  Address :</strong> 71-75, Shelton Street,<br> Covent Garden, London, WC2H 9JQ, <br>UNITED KINGDOM
                                    </a></li>
	                            </ul>
                            </div>
                        </div>
