        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="romana_section_title text-center">
                    ...
                    <p>We Offer a wide range of solutions.</p>
                </div>
            </div>
            <!-- column End -->
        </div>
        ...
        <div class="row ">
            <div class="col-sm-4">
                ...
                <div class="romana_single_service">
                    ...
                    <div class="read-more"> <a href="{{route('payment')}}">Take Solutions</a> </div>
                </div>
            ...
            <div class="col-xs-12">
                <div class="partner_crsl">
                    ...
                    <div class="romana_single_service">
                        ...
                        <p>It is a fully customized PBX solution from small to large corporates for solutions. You can take solution </p>
                        <div class="read-more"> <a href="{{route('payment')}}">Take Solutions</a> </div>
                    </div>
                    ...
                    <div class="romana_single_service">
                        ...
                        <p>We do Accounts Software, School Management Software and so on.Take any  solution.</p>
                        <div class="read-more"> <a href="{{route('payment')}}">Take Solutions</a> </div>
                    </div>
                    ...
                    <div class="romana_single_service">
                        ...
                        <p>Enjoy the peace of mind that comes with knowing your servers are protected.You can Take any kind of solution</p>
                        <div class="read-more"> <a href="{{route('payment')}}">Take Solutions</a> </div>
                    </div>
