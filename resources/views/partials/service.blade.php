        ...
        <div class="row ">
            <div class="col-sm-4">
                <div class="romana_single_service">
                    <a class="service-icon" href="#"><span><img src="{{url('images/webhosting.png')}}" alt=""width="100"height="100"></span>
            ...
            <div class="col-sm-4">
                <div class="romana_single_service">
                    <a class="service-icon" href="#"><span><img src="{{url('images/domain.png')}}" alt=""width="100"height="100"></span>
                ...
                <div class="romana_single_service">
                    <a class="service-icon" href="#"><span><img src="{{url('images/manageservices.png')}}"alt=""width="100"height="100"></span>
            ...
            <div class="col-sm-4">
                <div class="romana_single_service">
                    <a class="service-icon" href="#"><span><img src="{{url('images/webdevelopment.png')}}"alt=""width="100"height="100"></span>
